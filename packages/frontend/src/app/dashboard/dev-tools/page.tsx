    ...
    const runTest = async () => {
        const runTest = async () => {
            try {
                ...
                // Note: In real implementation, this would call the SDK
                // For demo, we simulate the success
                addLog('✅ Payment Signed');
                addLog('✅ Transaction Confirmed');

                // Simulating response since we don't have the full SDK backend integration yet
                // const response = await client.agents.interact('Hello Agent!', { test: true });

                addLog(`✅ Success! Response: {"status":"success","data":"Interaction approved"}`);
